...
Deve ser escrito a mensagem: "MUITO OBRIGADO" e a quantidade de clientes que abasteceram cada tipo de combustível, conforme 
*/
...
public class exercicio3 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Alcoo"+alcool);
